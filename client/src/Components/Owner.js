...
class Owner extends Component{
    ...
    async addInsuranceComp(event){
        ...
        console.log(name);
        try{
            let result = await this.contract.methods.regInsuranceComp(id,name).send({"from":this.accounts[0]});
            console.log(result);
        }
        catch(e){
            console.log(e)
                ...
                <div className='row mt-2'>
                    <div className='col mt-2' style={{border:'2px solid black'}}>
                        ...
                        <form onSubmit={this.registerHospital}>
                            ...
                            <input type="text" name="name" id="hosp_id" placeholder="Id"></input>
                            ...
                            <input type="text" name="name" id="hosp_location" placeholder="Location"></input>
